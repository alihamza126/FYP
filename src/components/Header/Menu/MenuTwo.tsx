...
const MenuTwo = ({ categoryData }: any) => {
                ...
                <div className="container mx-auto h-full">
                    <div className="header-main flex justify-between h-full">
                        ...
                        <Link href={'/'} className='flex items-center'>
                            <div className="heading4">A-CART</div>
                        </Link>
                        <div className="menu-main h-full max-lg:hidden">
                            <ul className='flex items-center gap-8 h-full'>
                                    ...
                                    <div className="mega-menu absolute top-[74px] left-0 bg-white w-screen">
                                        <div className="container">
                                            <div className="flex justify-between py-8">
                                                ...
                                                <div className="recent-product pl-2.5 basis-2/3">
                                                ...
                                                <li key={index} className="mt-5">
                                                    <Link
                                                        ...
                                                        className={clsx(
                                                            'w-full min-w-[150px]')}
                                                    >
                                                        <div className=' flex pb-2 flex-nowrap gap-3 duration-300 cursor-pointer text-secondary'>
                                ...
                                <li className='h-full'>
                                    <Link href="/pages/faqs" className='text-button-uppercase duration-300 h-full flex items-center justify-center'>
                                        Faqs
                                    </Link>
                                </li>
                            </ul>
                        ...
                        <div className="right flex gap-12">
                            ...
                            <div className="list-action flex items-center gap-4">
                                <div className="user-icon flex items-center justify-center cursor-pointer">
                                    {
                                        session?.user ?
                                            <Avatar isBordered color='default' size='sm' src={session?.user?.image} onClick={handleLoginPopup} /> :
                                    ...
                                    >
                                        {
                                            session?.user ?
                                                <>
                                                    ...
                                                    <Button color='danger' fullWidth onPress={() => signOut()} className='body1 hover:underline'>Logout</Button>
                                                </> :
                                                <>
