...
import { create, deleteOrder, getMyOrders, getOrder, listOrders, statsOrder, updateOrder, updateOrderStatus } from '../controllers/order.controller.js';

const ordersRouter = express.Router();


ordersRouter.get('/my-orders', authenticateUser, getMyOrders);
